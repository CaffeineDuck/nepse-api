...
This is the documentation for nepse-api, a library for Python to aid
in creating applications that utilise the NEPSE API.

Prerequisites
---------------

nepse-api works with Python 3.7 or higher. Support for earlier versions of Python
...
You can get the library directly from PyPI: ::
    ...
    python3 -m pip install -U nepse-api

If you are using Windows, then the following should be used instead: ::

    py -3 -m pip install -U nepse-api
...
A more in-depth tutorial is found on python-docs
